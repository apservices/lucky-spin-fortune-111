...
export const SlotMachine: React.FC<SlotMachineProps> = ({ 
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-pgbet-dark to-black text-white">
      ...
      <div className="bg-pgbet-gradient-machine p-4 border-b-4 border-hsl(45_100%_50%)">
        <div className="flex items-center justify-between max-w-md mx-auto">
          <div className="flex items-center space-x-2">
            <Menu className="w-6 h-6 text-hsl(45_100%_50%)" />
            <Trophy className="w-5 h-5 text-hsl(45_100%_50%)" />
            <Calendar className="w-5 h-5 text-hsl(142_86%_45%)" />
            <Gift className="w-5 h-5 text-hsl(0_85%_50%)" />
          </div>
          
          <div className="flex items-center space-x-3">
            <div className="flex items-center space-x-1 bg-black/30 px-3 py-1 rounded-full">
              <Crown className="w-4 h-4 text-hsl(45_100%_50%)" />
              <span className="text-sm font-bold">VIP {vipLevel}</span>
            </div>
            
            <div className="relative">
              <Bell className="w-6 h-6 text-hsl(45_100%_50%) animate-pgbet-coin-float" />
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-hsl(0_85%_50%) rounded-full"></div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xl text-hsl(45_100%_50%)">🐯 Tiger • Fox • Frog Edition 🐸</p>
        </div>
        ...
        >
          ...
          {jackpotEffect && (
            <div className="absolute inset-0 pointer-events-none z-30">
              ...
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-8">
                <div className="text-5xl font-bold text-hsl(45_100%_50%) animate-bounce text-center">
                  💰 MEGA JACKPOT! 💰
                </div>
              </div>
            </div>
          ...
          {/* Ornate Slot Frame */}
          <Card className="p-6 bg-pgbet-gradient-machine border-8 border-hsl(45_100%_50%) shadow-2xl rounded-3xl relative overflow-hidden">
            {/* Decorative corners */}
            <div className="absolute top-2 left-2 w-8 h-8 border-l-4 border-t-4 border-hsl(45_100%_50%) rounded-tl-lg"></div>
            <div className="absolute top-2 right-2 w-8 h-8 border-r-4 border-t-4 border-hsl(45_100%_50%) rounded-tr-lg"></div>
            <div className="absolute bottom-2 left-2 w-8 h-8 border-l-4 border-b-4 border-hsl(45_100%_50%) rounded-bl-lg"></div>
            <div className="absolute bottom-2 right-2 w-8 h-8 border-r-4 border-b-4 border-hsl(45_100%_50%) rounded-br-lg"></div>
            
            {/* Machine Header */}
            <div className="text-center mb-6">
              <div className="bg-pgbet-gradient-gold p-4 rounded-xl border-4 border-hsl(0_85%_50%) shadow-inner">
                <h3 className="text-3xl font-bold text-hsl(240_15%_8%) tracking-wider">FORTUNE REELS</h3>
